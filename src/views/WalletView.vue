        ...
        <div v-for="myvouchers in walletdata.user_vouchers" :key="myvouchers.voucherID" class="col-xl-2 col-lg-3 col-md-4 col-6">
          <div class="card border rounded">
            ...
            <div class="card-body row">
              ...
              <button class="btn-primary w-25 text-white m-2 btn col use " data-bs-toggle="modal" :data-bs-target="'#use-' + myvouchers.voucherID">Use</button>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body border-top">
                        <div class="row">
                            ...
                            <div class="col-2"></div>
                            <button type="button" :class="useResult!=''?'redeemBtnDisabled col-3':'redeemBtn col-3'" :disabled="useResult!=''"  @click="use(myvouchers.voucher_code,walletdata)" >Use</button>
                            <div class="col-2"></div>
                        </div>
                      </div>
                    </div>
        ...
        <div v-for="vouchers in walletdata.available_vouchers" :key="vouchers.voucherID"  class="col-xl-2 col-lg-3 col-md-4 col-6">
          <div class="card border rounded">
            ...
            <div class="card-body row">
              ...
              <button class=" btn-primary w-25 text-white m-2 btn col use" data-bs-toggle="modal" :data-bs-target="'#detail-' + vouchers.voucherID" >See more</button>
